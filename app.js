...
console.log(sonny.name + '\'s email is ' + sonny.email + ' and his number is ' + sonny.phone)

console.log(jordan.name + '\'s email is ' + jordan.email + ' and his number is ' + jordan.phone)
...
class Hand {
    ...
    getPoints() {
        let total = 0;
       this.currentHand.forEach(function(pointNumber) {
        //console.log(pointNumber.point);
        total += pointNumber.point;
       }
